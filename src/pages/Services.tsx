            ...
            >
              {filtered.map((service, i) => (
                <motion.div
                  ...
                  className="w-full sm:w-[calc(50%-10px)] lg:w-[calc(25%-15px)] bg-white rounded-2xl p-6 shadow-premium cursor-pointer group service-card flex flex-col items-start"
