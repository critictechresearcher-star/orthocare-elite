  ...
  return (
    <PageTransition>
      ...
      <section className="py-24 px-6 lg:px-10 bg-white relative overflow-hidden">
        <div className="absolute -top-24 -left-24 w-[420px] h-[420px] rounded-full opacity-20 blur-3xl pointer-events-none" style={{ background: '#C9A66B' }} />
        <div className="absolute top-1/3 -right-32 w-[480px] h-[480px] rounded-full opacity-15 blur-3xl pointer-events-none" style={{ background: '#00A99D' }} />
        <div className="absolute bottom-0 left-1/3 w-[360px] h-[360px] rounded-full opacity-10 blur-3xl pointer-events-none" style={{ background: '#0A2540' }} />
