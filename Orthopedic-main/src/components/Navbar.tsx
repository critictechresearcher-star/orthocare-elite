      ...
      <AnimatePresence>
        {microVisible && (
          <motion.div
            ...
            style={{
              background: isHome
                ? 'linear-gradient(to bottom, rgba(10,37,64,0.55) 0%, rgba(10,37,64,0.15) 100%)'
                : 'rgba(10,37,64,0.95)',
              backdropFilter: isHome ? 'blur(6px)' : 'blur(8px)',
              WebkitBackdropFilter: isHome ? 'blur(6px)' : 'blur(8px)',
            }}
